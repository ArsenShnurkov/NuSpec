...
namespace NuSpec.RazorHosting.Core
{
	...
	public class RazorEngineFactory<TBaseTemplateType> where TBaseTemplateType : RazorTemplateBase
	{
		/// <summary>
		...
		/// methods.
		/// </summary>
		private static RazorEngineFactory<TBaseTemplateType> Current;
